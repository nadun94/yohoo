...
import com.sliit.yoohoo.utils.MyFileProvider;
        ...
        public void setData(Message msg) {
            ...
            switch (msg.getAttachmentType()) {
                case AttachmentTypes.IMAGE:
                    ...
                    Glide.with(context).load(msg.getAttachment().getUrl()).apply(new RequestOptions().placeholder(R.drawable.yoohoo_placeholder)).into(imageView);
                    break;
